...
//   Copyright 2012 Michal Gebauer - modified to support unixtimestamp for date value
//
    ...
    public class XmlDeserializer : IDeserializer
	{
		...
		private void Map(object x, XElement root)
		{
			...
			foreach (var prop in props)
			{
				...
				{
                    // removed old DateTime parsing
                    value = Epoch.Epoch.FromUnix(Convert.ToInt32(value));
                    // end of removed code
